...
8. [Step 6 — Sign & Register](#step-6--sign--register)
...
12. [Step 10 — Verify & Manage Your Collector](#step-10--verify--manage-your-collector)
13. [Support](#support)
...
<img width="944" height="648" alt="Skärmavbild 2025-11-13 kl  20 12 40" src="https://github.com/user-attachments/assets/3dc941d7-fc82-4248-a8b2-816fc4228e93" />
...
* Optional: add or restrict specific continents/countries
  ...
  <img width="937" height="648" alt="Skärmavbild 2025-11-13 kl  20 13 20" src="https://github.com/user-attachments/assets/5d3bb7b0-73ce-4692-be78-297b33f5d0aa" />
...
<img width="953" height="647" alt="Skärmavbild 2025-11-13 kl  20 13 49" src="https://github.com/user-attachments/assets/276dae6a-e696-4aa8-b853-68d3788265df" />


---

## 🔏 Step 6 — Sign & Register

FluxCloud will now sign and register your app on-chain.
Wait for ✅ “Signing and Registration Complete.”

<img width="964" height="643" alt="Skärmavbild 2025-11-13 kl  20 14 52" src="https://github.com/user-attachments/assets/e9f560e2-fe50-4b9b-8f58-943c479282b0" />
...
<img width="971" height="707" alt="Skärmavbild 2025-11-13 kl  20 15 42" src="https://github.com/user-attachments/assets/248ed5b6-058c-4570-8403-65b5bfc8b54e" />
...
2. 
   <img width="598" height="315" alt="Skärmavbild 2025-11-13 kl  20 16 33" src="https://github.com/user-attachments/assets/3b8fd524-ec18-4efb-812d-069d84d42b15" />
...
4. In ZelCore, confirm:

   * Amount: **28.28 FLUX**
   * Note: same message string
     <img width="1037" height="400" alt="Skärmavbild 2025-11-13 kl  20 20 21" src="https://github.com/user-attachments/assets/8a830e05-5ee3-4609-bed6-c76db4f8a69c" />


5. Confirm → ✅ **Transaction Sent!**
   
   <img width="1074" height="520" alt="Skärmavbild 2025-11-13 kl  20 21 02" src="https://github.com/user-attachments/assets/8275bdc9-7181-4176-94a1-7328bc70f671" />


7. Return to FluxCloud → wait for **Payment Confirmation** (up to 45 minutes)
   <img width="980" height="645" alt="Skärmavbild 2025-11-13 kl  20 21 15" src="https://github.com/user-attachments/assets/8c55c7af-d744-4519-861a-8551c2bb0d93" />
...
<img width="1018" height="704" alt="Skärmavbild 2025-11-13 kl  20 24 08" src="https://github.com/user-attachments/assets/6c9c13d0-a5f0-44ac-969d-59d923733058" />


---

## 🧠 Step 10 — Verify & Manage Your Collector
...
1. Under **Specifications**, verify:
   ...
   * Status: ✅ Running
   * Instances: `3`
   * Ports: `5015` ( Not using anymore, but needed to be in there)
   * Container: `timpiltd/timpi-collector:latest`
   * GUID: matches your Collector
     <img width="1219" height="623" alt="Skärmavbild 2025-11-13 kl  20 25 12" src="https://github.com/user-attachments/assets/027f8764-b9a7-4a7b-b993-cc7b67314c4e" />
